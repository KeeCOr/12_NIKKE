...
public static class GameConfig {
    ...
    public static readonly float[] SQUAD_SLOT_X = { 0.55f, 1.65f, 2.75f, 3.85f, 4.95f };
    // Per-slot Y follows the battlefield diagonal perspective (right = further back = higher Y)
    public static readonly float[] SQUAD_SLOT_Y = { 0.64f, 0.88f, 1.12f, 1.36f, 1.60f };
    ...
    public const float DEFAULT_MAX_RANGE = 16f;
