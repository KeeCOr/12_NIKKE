...
| 전투 피드백 VFX 아틀라스 | `Assets/Sprites/UI/Generated/combat_feedback_vfx_atlas_v1.png` | 약점 명중, 치명타, 사정거리 밖, 재장전, EMP, 중력장, 화염, 쉴드 히트, 광폭화 경고, 탄착 VFX | 생성 완료, 투명 PNG |
| 캐릭터/보스 초상 | `Assets/Sprites/UI/Generated/Portraits/` | 하단 스쿼드 카드용 5인 초상화와 상단 보스 HUD용 보스 초상 | 생성 완료 |
...
| 캐릭터 카드 초상/상태 | `Assets/Scenes/Game.unity` | Alpha~Echo 카드에 초상화, 무기 아이콘, 상태 태그를 추가 |
| 보스 HUD 강화 | `Assets/Scenes/Game.unity` | 보스 초상 프레임과 광폭화 경고 VFX를 상단 보스 HUD에 추가 |
| 스킬바 확장 | `Assets/Scenes/Game.unity` | AIR, EMP, GRAV, LOCK 4칸 스킬바와 쿨타임/잠금 시각 상태를 추가 |
| 전투 피드백 HUD | `Assets/Scenes/Game.unity` | 약점, 치명타, 사정거리 밖, 쉴드 히트 피드백 배지를 추가 |
...
- 캐릭터/보스 초상은 `Assets/Sprites/UI/Generated/Portraits/`에 보관한다.
- 전투 피드백 VFX 슬라이스는 `Assets/Sprites/UI/Generated/VfxSlices/`에 보관한다.
